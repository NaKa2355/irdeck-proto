...
func (DeviceInfo_DeviceType) Descriptor() protoreflect.EnumDescriptor {
	return file_pirem_api_v1_device_info_proto_enumTypes[1].Descriptor()
}

func (DeviceInfo_DeviceType) Type() protoreflect.EnumType {
	return &file_pirem_api_v1_device_info_proto_enumTypes[1]
}
...
func (DeviceInfo_DeviceType) EnumDescriptor() ([]byte, []int) {
	return file_pirem_api_v1_device_info_proto_rawDescGZIP(), []int{0, 1}
}
...
type DeviceInfo struct {
	...
	Type            DeviceInfo_DeviceType  `protobuf:"varint,7,opt,name=type,proto3,enum=pirem.DeviceInfo_DeviceType" json:"type,omitempty"`
}
...
var file_pirem_api_v1_device_info_proto_rawDesc = []byte{
	...
	0x12, 0x05, 0x70, 0x69, 0x72, 0x65, 0x6d, 0x22, 0xff, 0x03, 0x0a, 0x0a, 0x44, 0x65, 0x76, 0x69,
	...
	0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x30, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x70, 0x69, 0x72, 0x65, 0x6d, 0x2e, 0x44, 0x65, 0x76,
...
var file_pirem_api_v1_device_info_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_pirem_api_v1_device_info_proto_goTypes = []interface{}{
	...
	(DeviceInfo_DeviceType)(0),  // 1: pirem.DeviceInfo.DeviceType
	(*DeviceInfo)(nil),          // 2: pirem.DeviceInfo
}
var file_pirem_api_v1_device_info_proto_depIdxs = []int32{
	0, // 0: pirem.DeviceInfo.service:type_name -> pirem.DeviceInfo.ServiceType
	1, // 1: pirem.DeviceInfo.type:type_name -> pirem.DeviceInfo.DeviceType
