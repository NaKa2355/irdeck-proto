...
type DevicePluginServiceClient interface {
	...
	GetDeviceInfo(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*v11.DeviceInfo, error)
	GetDeviceStatus(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*v11.DeviceStatus, error)
...
func (c *devicePluginServiceClient) GetDeviceInfo(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*v11.DeviceInfo, error) {
	out := new(v11.DeviceInfo)
...
func (c *devicePluginServiceClient) GetDeviceStatus(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*v11.DeviceStatus, error) {
	out := new(v11.DeviceStatus)
...
type DevicePluginServiceServer interface {
	...
	GetDeviceInfo(context.Context, *empty.Empty) (*v11.DeviceInfo, error)
	GetDeviceStatus(context.Context, *empty.Empty) (*v11.DeviceStatus, error)
...
func (UnimplementedDevicePluginServiceServer) GetDeviceInfo(context.Context, *empty.Empty) (*v11.DeviceInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDeviceInfo not implemented")
}
func (UnimplementedDevicePluginServiceServer) GetDeviceStatus(context.Context, *empty.Empty) (*v11.DeviceStatus, error) {
...
var DevicePluginService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pirem/plugin/v1/device_plugin.proto",
}
