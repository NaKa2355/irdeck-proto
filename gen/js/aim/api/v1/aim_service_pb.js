...
goog.exportSymbol('proto.aim.GetButtonssResponse', null, global);
 ...
 * @constructor
 */
proto.aim.GetButtonssResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.aim.GetButtonssResponse.repeatedFields_, null);
};
goog.inherits(proto.aim.GetButtonssResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.aim.GetButtonssResponse.displayName = 'proto.aim.GetButtonssResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.aim.GetButtonssResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.aim.GetButtonssResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.aim.GetButtonssResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.aim.GetButtonssResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.aim.GetButtonssResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    remotesList: jspb.Message.toObjectList(msg.getRemotesList(),
    aim_api_v1_remote_pb.Remote.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.aim.GetButtonssResponse}
 */
proto.aim.GetButtonssResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.aim.GetButtonssResponse;
  return proto.aim.GetButtonssResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.aim.GetButtonssResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.aim.GetButtonssResponse}
 */
proto.aim.GetButtonssResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.aim.GetButtonssResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.aim.GetButtonssResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.aim.GetButtonssResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.aim.GetButtonssResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getRemotesList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.aim.Remote>}
 */
proto.aim.GetButtonssResponse.prototype.getRemotesList = function() {
  return /** @type{!Array<!proto.aim.Remote>} */ (
    jspb.Message.getRepeatedWrapperField(this, aim_api_v1_remote_pb.Remote, 1));
};
...
/**
 * @param {!Array<!proto.aim.Remote>} value
 * @return {!proto.aim.GetButtonssResponse} returns this
*/
proto.aim.GetButtonssResponse.prototype.setRemotesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.aim.Remote}
 */
proto.aim.GetButtonssResponse.prototype.addRemotes = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.aim.Remote, opt_index);
};
 ...
 * @return {!proto.aim.GetButtonssResponse} returns this
 */
proto.aim.GetButtonssResponse.prototype.clearRemotesList = function() {
  return this.setRemotesList([]);
};
